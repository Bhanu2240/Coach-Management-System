...
//!_______________________________________new code____________________________________
import React from "react";

const MaintenanceTaskOutputForm = ({ AddMaintenace, deleteTask }) => {
    ...
    <div className="p-6">
      ...
      {approvedTasks.length === 0 ? (
        <div className="text-center text-gray-500 text-lg">
          No approved maintenance tasks available.
        </div>
      ) : (
