...
//!___________________________________new code__________________________________________
/** @format */
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl w-full max-w-xl">
            ...
            <form onSubmit={submitHandler} className="space-y-4">
              ...
              <select ref={coach} required className="w-full p-2 border rounded">
              ...
              <select ref={priority} required className="w-full p-2 border rounded">
              ...
              <select ref={department} required className="w-full p-2 border rounded">
